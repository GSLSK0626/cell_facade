...
def main():
    ...
    parser.add_argument('--dataset', '-i', default='./cell_image181102_crop',

                        help='Directory of image files.')

    parser.add_argument('--out', '-o', default='./test181107',
    ...
    train_d = FacadeDataset(args.dataset, data_range=(1, 250))

    test_d = FacadeDataset(args.dataset, data_range=(250, 387))
